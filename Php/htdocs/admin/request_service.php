...
<body>
  ...
  <div class="col-sm-6">
    ...
    <h3>Web Application Quotation : Request Sevice </h3>
    ...
    <div class="col-sm-6">
      ...
      <select class="form-control" name="jobsid_1" id="" required>
        <option value="" selected disabled>เลือกรับบริการ / รายละเอียด </option>
          <option value="ซ่อมคอมพิวเตอร์ / เครื่องเปิดไม่ติด / มีไฟเข้าแต่ไม่ขึ้นภาพ">ซ่อมคอมพิวเตอร์ / เครื่องเปิดไม่ติด / มีไฟเข้าแต่ไม่ขึ้นภาพ </option>
          <option value="ซ่อมปริ้นเตอร์ / สั่งพิมพ์ไม่ได้ / เปลี่ยนหัวพิมพ์ / สีเพี้ยน">ซ่อมปริ้นเตอร์ / สั่งพิมพ์ไม่ได้ / เปลี่ยนหัวพิมพ์ / สีเพี้ยน </option>
          <option value="ซ่อมจอคอมพิวเตอร์ / เปิดไม่ติด / ติดๆดับ / สีเพี้ยน">ซ่อมจอคอมพิวเตอร์ / เปิดไม่ติด / ติดๆดับ / สีเพี้ยน </option>
          <option value="ซ่อมเครื่องสำรองไฟ / เปลี่ยนแบตเตอรี่ / เปิดไม่ติด">ซ่อมเครื่องสำรองไฟ / เปลี่ยนแบตเตอรี่ / เปิดไม่ติด </option>
