...
$sql2 = "SELECT * FROM quotations,customers,jobs ORDER BY 'quotation.id,customer.id,jobs.id' DESC";
...
<body>
  ...
  <div class="container" align="">
    ...
    <a href="./reportquatation.php"><button class="btn btn-outline-dark">Report.</button></a>&nbsp;&nbsp;
...
?>
        ...
        <?php while($row=mysqli_fetch_assoc($result2)){?>
            <tr>
                ...
                <td>
                <a href="editFormquatation.php?id=<?php echo $row["qid"]?>" class="btn btn-primary">Edit</a>
                </td>
                <?php if ($mlevel == 'admin'){ ?>
                <td>
                    <a href='deleteQuatation.php?idquatation=<?php echo $row["qid"]?> 'class="btn btn-danger" onclick="return confirm('คุณต้องการลบข้อมูลหรือไม่')">Delete</a>
                </td>
